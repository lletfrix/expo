...
public final class EXUpdatesDatabase: NSObject {
  private static let EXUpdatesDatabaseManifestFiltersKey = "manifestFilters"
  private static let EXUpdatesDatabaseServerDefinedHeadersKey = "serverDefinedHeaders"
  private static let EXUpdatesDatabaseStaticBuildDataKey = "staticBuildData"
      ...
      do {
        _ = try execute(
          ...
          withArgs: [
            ...
            asset.filename.require("asset filename should be nonnull"),
            asset.contentHash,
            EXUpdatesDatabaseHashType.Sha1,
            asset.expectedHash
          ]
        )
      } catch {
  ...
  public func markMissingAssets(_ assets: [EXUpdatesAsset]) throws {
    ...
    for asset in assets {
      do {
        _ = try execute(sql: updateSql, withArgs: [EXUpdatesUpdateStatus.StatusPending, asset.assetId])
      } catch {
        sqlite3_exec(db, "ROLLBACK;", nil, nil, nil)
  ...
  public func allUpdates(withStatus status: EXUpdatesUpdateStatus, config: EXUpdatesConfig) throws -> [EXUpdatesUpdate] {
    ...
    let rows = try execute(sql: sql, withArgs: [status])
    return rows.map { row in
      update(withRow: row, config: config)
    }
  }
  ...
  public func launchableUpdates(withConfig config: EXUpdatesConfig) throws -> [EXUpdatesUpdate] {
    ...
    let sql = String(
      ...
      [EXUpdatesUpdateStatus.StatusReady, EXUpdatesUpdateStatus.StatusEmbedded, EXUpdatesUpdateStatus.StatusDevelopment]
    )
  ...
  public func serverDefinedHeaders(withScopeKey scopeKey: String) throws -> EXUpdatesDatabaseJsonData {
    return try jsonData(withKey: EXUpdatesDatabase.EXUpdatesDatabaseServerDefinedHeadersKey, scopeKey: scopeKey)
  }
  
  public func manifestFilters(withScopeKey scopeKey: String) throws -> EXUpdatesDatabaseJsonData {
    return try jsonData(withKey: EXUpdatesDatabase.EXUpdatesDatabaseManifestFiltersKey, scopeKey: scopeKey)
  }
  
  public func staticBuildData(withScopeKey scopeKey: String) throws -> EXUpdatesDatabaseJsonData {
    return try jsonData(withKey: EXUpdatesDatabase.EXUpdatesDatabaseStaticBuildDataKey, scopeKey: scopeKey)
  }
  
  public func setServerDefinedHeaders(_ serverDefinedHeaders: [String: Any], withScopeKey scopeKey: String) throws {
    return try setJsonData(serverDefinedHeaders, withKey: EXUpdatesDatabase.EXUpdatesDatabaseServerDefinedHeadersKey, scopeKey: scopeKey, isInTransaction: false)
  }
  
  public func setManifestFilters(_ manifestFilters: [String: Any], withScopeKey scopeKey: String) throws {
    return try setJsonData(manifestFilters, withKey: EXUpdatesDatabase.EXUpdatesDatabaseManifestFiltersKey, scopeKey: scopeKey, isInTransaction: false)
  }
  
  public func setStaticBuildData(_ staticBuildData: [String: Any], withScopeKey scopeKey: String) throws {
    return try setJsonData(staticBuildData, withKey: EXUpdatesDatabase.EXUpdatesDatabaseStaticBuildDataKey, scopeKey: scopeKey, isInTransaction: false)
  }
  ...
  public func setMetadata(withManifest updateManifest: EXUpdatesUpdate) throws {
    ...
    if let serverDefinedHeaders = updateManifest.serverDefinedHeaders {
      do {
        _ = try setJsonData(serverDefinedHeaders, withKey: EXUpdatesDatabase.EXUpdatesDatabaseServerDefinedHeadersKey, scopeKey: updateManifest.scopeKey, isInTransaction: true)
      } catch {
        sqlite3_exec(db, "ROLLBACK;", nil, nil, nil)
        throw EXUpdatesDatabaseError.setJsonDataError
      }
    ...
    if let manifestFilters = updateManifest.manifestFilters {
      do {
        _ = try setJsonData(manifestFilters, withKey: EXUpdatesDatabase.EXUpdatesDatabaseManifestFiltersKey, scopeKey: updateManifest.scopeKey, isInTransaction: true)
      } catch {
        sqlite3_exec(db, "ROLLBACK;", nil, nil, nil)
        throw EXUpdatesDatabaseError.setJsonDataError
      }
  ...
  private func update(withRow row: [String: Any?], config: EXUpdatesConfig) -> EXUpdatesUpdate {
    ...
    let update = EXUpdatesUpdate(
      ...
      keep: row.requiredValue(forKey: "keep"),
      status: EXUpdatesUpdateStatus.init(rawValue: row.requiredValue(forKey: "status"))!,
    ...
    update.successfulLaunchCount = row.requiredValue(forKey: "successful_launch_count")
    update.failedLaunchCount = row.requiredValue(forKey: "failed_launch_count")
    return update
  }
  ...
  private func asset(withRow row: [String: Any?]) -> EXUpdatesAsset {
    ...
    var extraRequestHeaders: [String: Any]? = nil
    ...
    asset.assetId = row.requiredValue(forKey: "id")
    asset.url = url
